...
public class NetloanlistXMLOut implements XMLBaseDto<XMLHeadDto,NetloanList> {
    private XMLHeadDto Head;
    private NetloanList Body;
    ...
    @Override
    public NetloanList getBody() {
        return Body;
    }

    @Override
    public void setBody(NetloanList body) {
        Body = body;
    }
}
