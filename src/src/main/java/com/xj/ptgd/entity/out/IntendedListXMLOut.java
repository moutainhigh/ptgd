...
public class IntendedListXMLOut implements XMLBaseDto<XMLHeadDto,IntendedList> {
    private XMLHeadDto Head;
    private IntendedList Body;
    ...
    @Override
    public IntendedList getBody() {
        return Body;
    }

    @Override
    public void setBody(IntendedList body) {
        Body = body;
    }
}
